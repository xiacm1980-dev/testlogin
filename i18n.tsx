...
const translations = {
  en: {
    ...
    'config.logs.desc': 'Logs in SQLite older than {days} days will be purged.',
    ...
    'config.backup.create_desc': 'Download a full snapshot of the SQLite database and config.',
