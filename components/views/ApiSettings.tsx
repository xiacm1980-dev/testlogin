...
const ApiSettings: React.FC = () => {
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
         <h2 className="text-2xl font-bold text-slate-900">API Interface Settings</h2>
         <p className="text-slate-500">Manage external access points and API keys.</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
         <div className="p-6 border-b border-slate-100 flex items-center gap-3">
             ...
             <div>
                <h3 className="font-semibold text-lg text-slate-800">REST API Configuration</h3>
         ...
         <div className="p-6 space-y-6">
            <div className="space-y-2">
               <label className="text-sm font-medium text-slate-700">Master API Key</label>
               ...
               <p className="text-xs text-slate-400">Used for sysadmin level integration. Keep secret.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700">Rate Limit (Req/min)</label>
                  <input type="number" defaultValue={600} className="w-full border border-slate-300 rounded-lg px-4 py-2" />
               </div>
               <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700">Session Timeout (sec)</label>
                  <input type="number" defaultValue={3600} className="w-full border border-slate-300 rounded-lg px-4 py-2" />
               </div>
            </div>
            
            <div className="pt-4 border-t border-slate-100 flex justify-end">
               <button className="bg-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors">Save Changes</button>
            </div>
         </div>
      </div>
    </div>
